...
Trading_Days = pl.read_parquet(r"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\TMI_Based\Trading Days\GCC_Trading_Days.parquet").with_columns(
...
sql = pl.SQLContext()
sql.register("df_left", Trading_Days)
...
missing_rows = filtered_df.join(Trading_Days, on="infocode", how="anti")

filtered_df.write_parquet(r"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\TMI_Based\Trading Days\Trading_Days_GCC_STOXXID.parquet")