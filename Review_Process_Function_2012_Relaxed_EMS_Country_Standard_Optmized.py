            ...
            for country in temp_Emerging_Aggregate.select(pl.col("Country")).unique().sort("Country").to_series():
                ...
                if len(Output_Count_Standard_Index.filter((pl.col("Country") == country) & (pl.col("Date") == Previous_Date))) > 0:
                    ...
                    # Lite Review for Jun and December
                        ...
                        if PreviousChairsNumber == 0: #TODO: Need to review this as changed Lite Review
                            PreviousChairsNumber = len(TopPercentage)
...
# Store the Results
Standard_Index.write_csv(rf"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\TMI_Based\Output\Tests\Standard_Index_Security_Level_CNTarget_{CN_Target_Percentage}_" + current_datetime + ".csv")
Standard_Index_Shadows.write_csv(rf"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\TMI_Based\Output\Tests\Standard_Index_Security_Level_Shadows_CNTarget_{CN_Target_Percentage}_" + current_datetime + ".csv")
...
).write_csv(rf"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\TMI_Based\Output\Tests\Standard_Chairs_Recap_{CN_Target_Percentage}_" + current_datetime + ".csv")
...
GMSR_Frame.write_csv(rf"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\TMI_Based\Output\Tests\GMSR_Frame_STANDARD.csv")
